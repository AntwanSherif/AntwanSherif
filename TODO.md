...
- [ ] **README: update projects showcase** — review and refresh `README.md`; remove outdated Trade Republic job reference and old side-projects list (Dinney, 21Farmer, El-Mawkaa, Paper-Scissors-Rock); add newer side-projects that better represent current work and focus. Pick up later when free.
