      ...
      >
        ...
        <ThemeProvider attribute='class' defaultTheme='dark' forcedTheme='dark'>
          <TooltipProvider delayDuration={0}>
            {/* Animated plasma background — fixed, behind every page for site-wide
                consistency. print:hidden so it never bleeds into the /cv PDF. */}
            <PlasmaField className='fixed inset-0 w-screen h-screen -z-10 pointer-events-none print:hidden' />
            {children}
          </TooltipProvider>
        </ThemeProvider>
      </body>
