...
export type CVExperience = {
  ...
  tag?: string;
  tagTone?: 'neutral' | 'success' | 'amber' | 'violet';
...
export const CV: CVData = {
  ...
  summary: [
    'Senior software engineer with 10+ years building revenue-critical, customer-facing products across consumer, fintech, and SaaS platforms. Delivered measurable business outcomes including **+18% AOV** growth at Flink, ~**€1M/year** infrastructure savings at Trade Republic, and a self-service app used by over **2 million** Vodafone customers.',
    'Combines deep expertise in React with product thinking to build AI-native products and developer tooling, applying multimodal AI, evaluation pipelines, MCP-servers, and cost-aware inference to create reliable developer and user experiences.'
  ],
  experience: [
    {
    ...
    },
    {
      ...
      groups: [
        ...
        },
        {
          ...
          bullets: ['Grew 2 engineers to independent feature ownership, deepening their debugging skills.']
        }
      ]
    },
    {
      ...
      groups: [
        {
          ...
          bullets: [
            "Built Vodafone Turkey's *Product Selector* — a consumer self-service app used by **2M+ customers** across all Vodafone Turkey retail stores.",
            'Modernized the legacy Vodafone DE sales-agent app to React/TypeScript, improving maintainability and enabling faster development lifecycle.',
  ...
  skills: [
    {
      category: 'Frontend',
      items: ['React', 'Next.js', 'Vue.js', 'Nuxt', 'TypeScript', 'React Native', 'Design Systems', 'TanStack Query']
    },
    {
      category: 'AI Engineering',
      items: ['AI SDK', 'AI Gateway', 'LLM Evals', 'MCP servers', 'Multimodal AI', 'Claude/Cursor']
    },
    {
      category: 'Product & Experimentation',
      items: ['Product analytics', 'Feature flagging', 'A/B testing']
    },
    {
      category: 'Automated Testing',
      items: ['Playwright', 'Jest', 'Vitest', 'Testing Library']
    },
    {
      category: 'Architecture & Infrastructure',
      items: ['Micro-frontends', 'Monorepos', 'CI/CD', 'npm packaging', 'Sentry/Datadog', 'Performance optimizations']
    },
    {
      category: 'Backend & APIs',
      items: ['Node.js', 'Bun', 'Hono', 'REST', 'GraphQL']
    }
  ],
  projects: [
    {
      ...
      tagTone: 'violet',
      description:
        'AI-native SaaS that automatically curates the best concert photos & videos. Built a multimodal vision pipeline combining cloud and on-device inference, reducing inference cost by 40–60%. Developed evaluation framework for side-by-side prompts and model iterations to continuously improve quality.',
      tech: ['AI SDK', 'AI Gateway', 'Bun', 'React', 'FFmpeg']
    },
    {
      name: 'HAKTIV',
      role: 'Freelancer',
      ...
      description:
        'Client-delivered the first bug bounty and crowdsourced pentesting platform in MENA. Later pivoted to AI-powered GRC compliance, backed by Microsoft, Misk, and Plug and Play.',
    ...
    },
    {
      ...
      tagTone: 'success',
      description:
        'Client-delivered a B2B construction materials marketplace — 65K downloads, 1,300+ suppliers; a [seven-figure SAR exit](https://www.wamda.com/2024/10/ayen-acquires-elmawkaa-seven-figure-deal).',
  ...
  training: [
    {
      title:
        '[AI SDK & Agents Building](https://www.aihero.dev/cohorts/build-your-own-ai-personal-assistant-in-typescript)',
      detail: 'Matt Pocock'
    },
    {
